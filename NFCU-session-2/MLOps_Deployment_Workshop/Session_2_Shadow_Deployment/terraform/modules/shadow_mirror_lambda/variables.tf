# ABOUTME: Inputs for the shadow_mirror_lambda module.
# ABOUTME: Function source, endpoint ARNs, and the shadow-logs bucket.
...
variable "champion_endpoint_arn" {
  description = "ARN of the champion SageMaker endpoint."
  type        = string
}

variable "challenger_endpoint_arn" {
  description = "ARN of the challenger SageMaker endpoint."
  type        = string
}
